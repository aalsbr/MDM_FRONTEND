...
import { Container, CardHeader, Card, Snackbar , CardContent, TextField, FormControlLabel, Checkbox, Button, Link, Typography } from '@material-ui/core';
...
function Alert(props) {
  ...
  function LoginForm() {
    ...
    const handleSubmit = async (event) => {
      ...
      const response = await fetch('/api1/auth/login', {
        method: 'POST',
        headers: {
